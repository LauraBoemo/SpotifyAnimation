  ...
  return(
	<AbsoluteFill style={{background: '#4e00f9',}}>
		<AbsoluteFill style={{transform: `translateY(${-contenttranslation}px)`}}>
			<Title style={{opacity: textopacity}}>Laurinha Laurinha Laurinha <br/> Laurinha</Title>
			<Title style={{top: 1030, fontSize: 25, opacity: bottomtextopacity }}>{topsongartistname}</Title>
			<Title style={{top: 1100, fontSize: 40, opacity: artisttextopacity}}>Laurinha embaixo embaixo {topsongname}</Title>
			<Circle 
				style={{
      opacity: progress,
